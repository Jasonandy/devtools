...
function GenerateContentList() {
    ...
    $($("#cnblogs_post_body")[len - 1]).append("<div id='signature'><p>作者：<a href='https://www.cnblogs.com/jasonandy/'></a> 安以北往南 </br>GitHub：<a href='https://github.com/Jasonandy'> Jasonandy </a></br>欢迎任何形式的转载，但请务必注明出处。</br>限于本人水平，如果文章和代码有表述不当之处，还请不吝赐教。</p></div>")
}
...
$(function () {
    customTimer("#div_digg", function () {
        var div_html = "<div class=''>                        <a href='javascript:void(0);' onclick='c_follow();'>关注我</a>                         &nbsp;|&nbsp;                        <a href='#top'>顶部</a>                         &nbsp;|&nbsp;                        <a href='javascript:void(0);' onclick=\" $('#tbCommentBody').focus();\">评论他</a>                   </div>";
